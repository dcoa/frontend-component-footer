...
var getLocaleName = function getLocaleName(locale) {
  ...
  return langName.replace(/^\w/, function (c) {
...
var LanguageSelector = function LanguageSelector(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return changeUserSessionLanguage(selectedLocale);
          case 3:
  ...
  var currentLocaleLabel = useMemo(function () {
    if (width < 576) {
      return '';
    }
    if (width < 768) {
  ...
  return /*#__PURE__*/React.createElement(Dropdown, {
    ...
    size: "sm"
  }, currentLocaleLabel), /*#__PURE__*/React.createElement(Dropdown.Menu, null, /*#__PURE__*/React.createElement(Scrollable, {
    style: {
      maxHeight: '40vh'
    }
  }, options.map(function (locale) {
