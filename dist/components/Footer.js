...
subscribe(APP_PUBSUB_INITIALIZED, function () {
  mergeConfig({
    GOOGLE_TAG_MANAGER_ID: process.env.GOOGLE_TAG_MANAGER_ID || '',
    GOOGLE_TAG_MANAGER_ENVIRONMENT: process.env.GOOGLE_TAG_MANAGER_ENVIRONMENT || ''
  }, 'NauFooter');
});
subscribe(APP_CONFIG_INITIALIZED, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
var AdditionalLogosSection = function AdditionalLogosSection() {
  var FOOTER_ADDITIONAL_LOGOS = getConfig().FOOTER_ADDITIONAL_LOGOS || process.env.FOOTER_ADDITIONAL_LOGOS;
  var logos = parseEnvSettings(FOOTER_ADDITIONAL_LOGOS);
  if (!logos) {
    return null;
  }
  return /*#__PURE__*/React.createElement("section", {
    className: "footer-additional-logos"
  }, logos.map(function (line) {
    return /*#__PURE__*/React.createElement("div", {
      className: "footer-additional-logos__line"
    }, Array.isArray(line) && line.map(function (logo) {
...
var FooterPoweredBy = function FooterPoweredBy(_ref3) {
  var intl = _ref3.intl;
  var POWERED_BY = getConfig().LOGO_POWERED_BY || process.env.LOGO_POWERED_BY;
  var poweredBy = parseEnvSettings(POWERED_BY);
  if (!poweredBy) {
    return null;
  }
  return /*#__PURE__*/React.createElement("a", {
...
var SiteFooter = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(SiteFooter, [{
    ...
    value: function render() {
      ...
      })), /*#__PURE__*/React.createElement(FooterCopyrightSection, {
        intl: intl
      ...
      }))), /*#__PURE__*/React.createElement(AdditionalLogosSection, null), config.MODAL_UPDATE_TERMS_OF_SERVICE && /*#__PURE__*/React.createElement(ModalToS, null));
    }
  }]);
  return SiteFooter;
}(React.Component);
